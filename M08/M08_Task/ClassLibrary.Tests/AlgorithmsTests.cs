    ...
    public class AlgorithmsTests
    {
        ...
        public void BinarySearch_NullArguments_ThrowsArgumentNullException()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(() => Algorithms.BinarySearch(null, item),
                    Throws.ArgumentNullException);
                Assert.That(() => Algorithms.BinarySearch(null, null),
                    Throws.ArgumentNullException);
            });
        }

        [Test]
        public void BinarySearch_DifferentTypes_ThrowsArgumentException()
        {
            var array = new ArrayList() { "1", 2, 3 };
            var item = 1;
            ...
            Assert.That(() => Algorithms.BinarySearch(array, item),
                Throws.ArgumentException.
                    With.Message.
                    EqualTo("Arguments must have same type."));
        }
        ...
        public void BinarySearch_ItemAtEnd_ReturnsArrCountMinusOne()
        {
            ...
            Assert.That(result, Is.EqualTo(array.Count -1));
        }
